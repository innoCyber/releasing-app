package ptml.releasing.admin_configuration
...
class AdminConfigTest : BaseApiTest() {
    ...
    private lateinit var viewModel: AdminConfigViewModel
    ...
    override fun setUp() {
        ...
        this.viewModel = ViewModelProviders.of(this.activity, viewModelFactory).get(AdminConfigViewModel::class.java)
    }
    ...
    fun getAdminConfigurationSuccess() {
        // Prepare data
        this.mockHttpResponse("configSuccess.json", HttpURLConnection.HTTP_OK)
        ...
        kotlin.test.assertNotNull(viewModel.configResponse.value, "Response should not be null, request is successful")
    ...
    @Test
    fun getAdminConfigurationFailure() {
        // Prepare data
        ...
        kotlin.test.assertNotNull(viewModel.configResponse, "Response should not be null, request is successful ")
    ...
    @Test
    fun getAdminConfigurationWithNetworkFailure() {
        // Prepare data
