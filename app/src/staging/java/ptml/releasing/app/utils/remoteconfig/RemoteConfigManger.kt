...
class RemoteConfigManger @Inject constructor() {
    ...
    companion object {
        ...
        const val APP_CURRENT_VERSION = "app_current_version_staging"
        const val APP_MINIMUM_VERSION = "app_version_minimum_staging"
        const val QUICK_REMARKS_CURRENT_VERSION = "quick_remarks_current_version_staging"
        const val DAMAGES_CURRENT_VERSION = "damages_current_version_staging"
