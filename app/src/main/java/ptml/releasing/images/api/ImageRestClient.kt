...
class ImageRestClient @Inject constructor(
    context: Context,
    gson: Gson,
    ...
    private val api: UploadImageService
    ...
    init {
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl(BuildConfig.BASE_IMAGE_UPLOAD_URL)
            .addConverterFactory(GsonConverterFactory.create(gson))
            .client(client)
            .build()

        api = retrofit.create(UploadImageService::class.java)
    }
